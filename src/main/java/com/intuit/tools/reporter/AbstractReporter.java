...
abstract class AbstractReporter {
	private volatile static List<com.intuit.tools.reporter.services.LogAction> actionList = new ArrayList<LogAction>();
	...
	protected List<com.intuit.tools.reporter.services.LogAction> getActionList() {
		return actionList;
	}
	...
	/**
	 * @param action
	 *            - A {@link com.intuit.tools.reporter.services.LogAction} object that represents the custom log
